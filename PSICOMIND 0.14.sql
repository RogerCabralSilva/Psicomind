...
-- Tabela Agendamento Indisponíveis
CREATE TABLE agendamento_indisponiveis (
	id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    datas_excluidas DATE NOT NULL,
    motivo_indisponivel VARCHAR(100) NULL
);
...
CREATE TABLE escala (
    ...
    horario_começo TIME NOT NULL,
    horario_fim TIME NOT NULL,
    duracao TIME NOT NULL,
    profissionais_id INT NOT NULL,
    vagas_quantidade DECIMAL(10,2) NOT NULL,
    agend_indisponiveis_id INT NOT NULL,
    ferias_id INT NOT NULL,
    CONSTRAINT fk_escala_profissionais_id FOREIGN KEY (profissionais_id) REFERENCES profissionais(id),
    CONSTRAINT fk_agendIndisponiveis_id FOREIGN KEY (agend_indisponiveis_id) REFERENCES agendamento_indisponiveis(id),
    CONSTRAINT fk_feriasEscala_id FOREIGN KEY (ferias_id) REFERENCES ferias(id)
...
CREATE TABLE consultas (
    ...
    motivos_consulta VARCHAR(200) NULL,
